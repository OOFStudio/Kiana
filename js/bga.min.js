(function(g, d) {
	function h(a) {
		...
		this.d = "../Kiana/src/"/*指出img和voice文件的路径*/;
		this.A = {
			kiana : {
				s : {
					stand : {
	...
	h.prototype = {
		...
		I : function(a, c) {
			...
			if (a && this.A[a]) {
				...
				this.a.b.on(this.k[this.g].mousedown + ".bhxy", function(a) {
					a.preventDefault();
					var c = b.n(a).x - d(this).offset().left, h = b.n(a).y - d(this).offset().top;
		...
		random : function() {
			var a = this, c = 1E3 * Math.round(5 * Math.random() + 5);
			clearTimeout(this.v);
		...
		j : function(a, c) {
			var b = this, f = this.a.c.j[a] || a, e = a;
			clearTimeout(this.r);
			this.l(0);
